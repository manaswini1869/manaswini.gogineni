      ...
      <div className="space-y-8 text-center">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm md:text-base text-gray-600 max-w-xs mx-auto leading-relaxed">
            2+ years of experience in software development, with a strong
            passion for artificial intelligence and its real-world applications.
            Specializes in backend systems, cloud infrastructure, and
            automation, with a focus on building scalable solutions and
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-center space-x-4 pt-2">
            ...
            <a
              href="https://drive.google.com/file/d/1OTgfcGWva0m0oxcQXzQ50nd9S0MJGyUl/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 text-gray-600 hover:text-gray-900"
            >
